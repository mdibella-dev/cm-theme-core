...
function post_type_speaker__register()
{
    $labels = [
        ...
        'singular_name'         => esc_html__( 'Speaker', 'cm-theme-core' ),
        'menu_name'             => esc_html__( 'Speakers', 'cm-theme-core' ),
        'all_items'             => esc_html__( 'Speakers', 'cm-theme-core' ),
        'add_new'               => esc_html__( 'Add new', 'cm-theme-core' ),
        'search_items'          => esc_html__( 'Search speaker', 'cm-theme-core' ),
        'not_found'             => esc_html__( 'No speaker found', 'cm-theme-core' ),
        'not_found_in_trash'    => esc_html__( 'No deleted speaker found', 'cm-theme-core' ),
        'featured_image'        => esc_html__( 'Speaker image', 'cm-theme-core' ),
        'set_featured_image'    => esc_html__( 'Set speaker image', 'cm-theme-core' ),
        'remove_featured_image' => esc_html__( 'Remove speaker image', 'cm-theme-core' ),
        'use_featured_image'    => esc_html__( 'Use as speaker image', 'cm-theme-core' ),
        'archives'              => esc_html__( 'All speakers', 'cm-theme-core' ),
        'name_admin_bar'        => esc_html__( 'Speaker', 'cm-theme-core' ),
    ];

    $args = [
        'label'                 => esc_html__( 'Speakers', 'cm-theme-core' ),
        'labels'                => $labels,
        'description'           => '',
        'public'                => false,
